...
public class ContractorTasks : IPlayerTaskGroup
{
    ...
    public void StartHitmanTask(ContractorContact contact)
    {
        HitmanTask HitmanTask = new HitmanTask(Player, Time, Gangs, PlayerTasks, PlacesOfInterest, ActiveDrops, Settings, World, Crimes, Names, Weapons, ShopMenus, contact);
        AllTasks.Add(HitmanTask);
        HitmanTask.Setup();
        HitmanTask.Start(contact);
    }
